...
export default function Register() {
  const { signUp, signInWithGoogle, needsProfileCompletion } = useAuth()
  ...
  async function onSubmit(data) {
    try {
      setServerError('')
      await signUp(data)
      // FIX 4: Se o backend falhou e o perfil não foi criado, redireciona para
      // /completar-perfil em vez de /dashboard — evita o flash do OAuthGuard
      navigate(needsProfileCompletion ? '/completar-perfil' : '/dashboard')
    } catch (err) {
      // Apenas erros do Supabase Auth chegam aqui (e-mail já cadastrado, senha fraca, etc.)
  ...
  async function handleGoogleSignIn() {
    try {
      ...
      // Após o redirect do OAuth, OAuthGuard em App.jsx cuida do redirecionamento
    } catch {
      setServerError('Não foi possível continuar com o Google. Tente novamente.')
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-heading text-3xl font-bold text-bg-dark">Criar conta gratuita</h1>
        ...
        <Card variant="elevated">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="font-body text-xs text-gray-400">ou cadastre-se com e-mail</span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>
